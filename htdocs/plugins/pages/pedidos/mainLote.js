...
$("#buscaNomeLote").keypress(function(event) {
if (event.keyCode === 13) {
    $("#buscarLote").click();
}
});

$("#buscaNomeLocal").keypress(function(event) {
if (event.keyCode === 13) {
    $("#buscarLocal").click();
}
});
...
// INCLUIR LOTE
function incluirLote(intValue) {

    document.getElementById('loteMaterial').value = intValue;
    $('#buscarLoteModal').modal('toggle');
    document.getElementById('loteMaterial').focus();
    document.getElementById('localMaterial').focus();

}

// INCLUIR LOCAL
function incluirLocal(intValue) {

    document.getElementById('localMaterial').value = intValue;
    $('#buscarLocalModal').modal('toggle');
    document.getElementById('localMaterial').focus();
    document.getElementById('quantidadeMaterial').focus();
...
var paginaOperacao = 'buscarLote';

var nome = document.getElementById("buscaNomeLote").value;
...
var paginaOperacao = 'buscarLocal';

var nome = document.getElementById("buscaNomeLocal").value;
